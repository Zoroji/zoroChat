      ...
      <div className='pb-5'>
        <div className='flex justify-between items-center'>
          ...
          <div className='relative py-2 group'>
            ...
            <div className='absolute top-full right-0 z-20 w-32 p-5 rounded-md bg-[#282142] border-gray-600 text-gray-100 hidden
        group-hover:block'>
        ...
        <div className='bg-[#282142] rounded-full flex items-center gap-2 py-3 px-4 mt-5'>
          ...
          text-white text-xs placeholder:[#c8c8c8] flex-1' placeholder='search your friend' name="" id="" />
        </div>
